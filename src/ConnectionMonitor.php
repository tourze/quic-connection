...
class ConnectionMonitor
{
    ...
    public function onPacketSent(Connection $connection, array $data): void
    {
        ...
        $this->statistics['bytes_sent'] += $data['size'] ?? 0;
    }
    ...
    public function onPacketReceived(Connection $connection, array $data): void
    {
        ...
        $this->statistics['bytes_received'] += $data['size'] ?? 0;
    }
    ...
    public function getStatistics(): array
    {
        ...
        // 计算速率
        if ($stats['uptime'] > 0) {
            $stats['packets_per_second'] = $stats['packets_sent'] / $stats['uptime'];
            $stats['bytes_per_second'] = $stats['bytes_sent'] / $stats['uptime'];
        }
    ...
    public function getHealthStatus(): array
    {
        ...
        return [
            'is_healthy' => $state->isActive() && $this->statistics['errors'] === 0,
            'state' => $state->value,
